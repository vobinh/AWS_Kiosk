...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Kiosk.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (Kiosk.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Kiosk.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Kiosk.getGlobalCssPath() + file + ".css");
