<div class="col-md-12">
	<div class="portlet">
		<div class="portlet-title">
			<div class="caption">
				<?php echo !empty($title)?$title:'Register New Inventory Item'; ?>
			</div>
		</div>
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
			<form id="frm-registry" action="<?php echo url::base() ?>warehouse/saveRegistry" method="post" class="form-horizontal" enctype="multipart/form-data">
				<div class="form-body">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
							...
							<div class="border add-catalog" style="height: 220px; text-align: center;">
								...
								<div class="fileinput <?php echo !empty($data['file_id'])?'fileinput-exists':'fileinput-new' ?>" data-provides="fileinput" style="position: relative;">
									<div class="fileinput-new thumbnail" style="max-width: 140px; max-height: 140px;">
										<img src="http://www.placehold.it/140x140/EFEFEF/AAAAAA&amp;text=no+image" alt=""/>
									</div>
									<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 140px; max-height: 140px;">
									...
									<div>
										<span class="btn btn-sm default btn-file">
											...
											<span class="cls-change fileinput-exists">Change </span>
						...
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="border add-catalog in-group" style="height: 220px;">
								<h4>Item Name</h4>
								<div class="input-icon input-icon-sm right catalog-middle">
...
<script type="text/javascript">
    ...
    $(document).on('change', '#txt_icon', function() {
    	var frm = $(this).parents('.add-catalog');
		Kiosk.blockUI({
            target: $(frm),
           	textOnly: true
