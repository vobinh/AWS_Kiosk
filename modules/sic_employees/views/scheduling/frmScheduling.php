...
<div class="col-md-12">
	<div class="portlet">
		...
		<div class="portlet-body form wap-scheduling">
			<!-- BEGIN FORM-->
			<form id="frm-scheduling" action="<?php echo url::base() ?>employees/saveScheduling" method="post" class="form-horizontal">
				<div class="form-body">
					<div class="row">
						<div class="col-md-12">
						...
						<div class="col-md-12">
							...
							<?php if(!empty($dataScheduling)): ?>
								<?php foreach ($dataScheduling as $key => $value): ?>
									<div class="item-add-category">
										...
										<div class="col-xs-9 col-md-2 in-group">
											...
											<input type="hidden" name="txt_hd_id[]" value="<?php echo !empty($value['employee_schedule_id'])?$value['employee_schedule_id']:'' ?>">
										</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		frmScheduling.init();
		<?php if($role == 'NoAccess' || (is_array($role) && substr($role['employees_scheduling'], -1) == '0')){ ?>
			$('#frm-scheduling').attr('action', 'javascript:void(0);');
		<?php } ?>
	});
</script>