<div class="content" id="wap-login">
    <form id="frm-change-pass" action="<?php echo url::base() ?>admin_login/sm_change_pass" method="post">
        <h3 class="form-title-location">Site Administration</h3>
        <h3 class="form-title-location-name">
            Welcome, <?php echo $this->sess_admin['super_name'] ?>
        </h3>
        ...
        <div class="create-account" style="overflow: hidden;">
            <a type="button" href="<?php echo url::base()  ?>admin_login/logout" class="btn btn-sm default dark-stripe pull-right">Log Out</a>
        </div>
    </form>
</div>