<div class="content" id="wap-login">
    <!-- BEGIN LOGIN FORM -->
    <form id="frmLogin" class="login-form" action="<?php echo url::base() ?>admin_login/sm_login" method="post">
        <h3 class="form-title">Site Administration</h3>
        ...
        <!-- <div class="create-account">
            ...
            <button type="button" class="btn btn-sm default dark-stripe pull-right">Contact Support</button>
        </div> -->
    </form>
    <!-- END LOGIN FORM -->
