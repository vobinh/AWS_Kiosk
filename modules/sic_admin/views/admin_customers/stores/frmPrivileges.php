<div class="col-md-12">
	<div class="portlet">
		...
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
			<form id="frm-privileges" action="<?php echo url::base() ?>admin_customers/saveDefaultPrivileges" method="post" class="form-horizontal">
				<div class="form-body">
					<div class="row">
						<div class="col-md-3">
							<table>
				...
				<div class="form-actions right">
					...
					<input type="hidden" name="txt_hd_admin_id" value="<?php echo !empty($adminId)?$adminId:''; ?>">
...
<script type="text/javascript">
	...
	function handleFrmEvent(){
		...
		$('.btn-set-default').click(function(event) {
			...
			Kiosk.blockUI();
			$.ajax({
				url: '<?php echo url::base() ?>admin_customers/getPrivileges',
				type: 'POST',
				dataType: 'json',
