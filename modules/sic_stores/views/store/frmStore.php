<div class="col-md-12">
	<div class="portlet">
		...
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
			<form id="frm-store" action="<?php echo url::base() ?>store/save" method="post" class="form-horizontal">
				<div class="form-body">
					<div class="row">
						<div class="col-md-12">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<div class="col-md-4 in-group">
									...
									<input type="text" name="txt_store_e_serial_number" class="form-control input-sm cls-check" value="<?php echo !empty($data['e_serial_number'])?$data['e_serial_number']:''; ?>" placeholder="Serial Number">
								</div>
								<div class="col-md-4 in-group">
				...
				<input autocomplete="off" type="hidden" name="txt_admin_id" value="<?php echo $admin_id ?>">
