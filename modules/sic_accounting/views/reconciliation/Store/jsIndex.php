<script type="text/javascript">
	var Store_Accounting = function(){
		...
		var handleData = function(storeId){
			...
			tbData = $("#tb-store-accounting").DataTable({
				"searching": false,
				"ordering": false,
				"scrollX": true,
				"bLengthChange": true,
		...
		return {
			...
			TypeItemSold: function(type){
				$('#type_item_sold').val(type);
				Kiosk.blockUI();
				$('#frm-accounting').submit();
			},
