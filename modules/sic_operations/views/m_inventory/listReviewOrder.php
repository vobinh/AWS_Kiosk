		...
		<div class="portlet-body form wap-place-order">
			...
			<div class="table-responsive table-datatable filter-hidden" style="position: relative;">
				...
				<div style="text-align: right;padding-bottom: 10px;font-size: 16px;font-weight: 600;">
					Total Cost: $<span class="lb-total"><?php echo number_format(0,2); ?></span>
				</div>
			</div>
	...
	var frmViewOrder = function(){
		...
		return {
			...
			loadData: function(){
				...
				tbPlaceOrder.init({
					...
					dataTable: {
						...
						scrollY: '345px',
						"ajax":{
							"url" : "<?php echo url::base()?>catalogs/jsViewOrder",
						},
						"columns": [{
			                "data": null,
			                "class": "",
			                ...
			                "render": function ( data, type, full, meta ) {
			                	...
			                	if(full.tdComplete && full.tdComplete == 0){
			                		var _str = '<a href="javascript:;" class="btn btn-md btn-order btn-complete">';
			                		...
			                		var _str = '<a onclick="frmViewOrder.markAsComplete(\''+full.tdID+'\')" href="javascript:;" class="btn btn-md btn-order green tooltips" data-container=".page-quick" data-original-title="Mark order as complete once you receive your orders. Inventory will be updated.">';
									_str +=	'<span><i style="font-size: 20px;position: relative;top: 2px;" class="fa fa-check-circle" aria-hidden="true"></i></span>';
			                		...
			                		var _str = '<a style="text-align: left;min-width: 11.3em;padding: 6px;padding-bottom: 3px;padding-top: 3px;" href="javascript:;" class="btn btn-md btn-order btn-waiting tooltips" data-container=".page-quick" data-original-title="Awaiting approval from warehouse">';
			...
			markAsComplete: function(id){
	        	Kiosk.blockUI();
				$.ajax({
					url: '<?php echo url::base() ?>catalogs/markAsComplete',
					type: 'POST',
					dataType: 'json',
					data: {
						'id_store_order': id
		            ...
		            buttons: {
		              cancel: {
		            	...
		            	if(result){	
		            		Kiosk.blockUI();
							$.ajax({
								url: '<?php echo url::base() ?>catalogs/del_store_order',
								type: 'POST',
								dataType: 'json',
	        ...
	        export: function(id){
	        	if(id.length > 0){
	        		$('<form>', {
					    ...
					    "action": '<?php echo url::base() ?>catalogs/exportOrder',
					    "method": 'post'
