<div class="row">
	<div class="col-md-12 div-btn-top">
		...
		<button type="button" class="btn btn-primary btn-lg" style="position: relative;">Inventory</button>
...
<?php if($this->mPrivileges == 'NoAccess' || (is_array($this->mPrivileges) && substr($this->mPrivileges['operations_inventory'], 0, 1) == '0')){ ?>
	...
	<div class="col-md-12">
		<div class="portlet solid grey-cararra bordered wap-content-inventory">
					...
					if($role == 'FullAccess' || (is_array($role) && substr($role['operations_inventory'], -1) == '1')): ?>
						<div class="table-action">
							...
							<button type="button" class="btn green btn-view-order" onclick="inventoryWarehouse.reviewOrder()" style="position: relative;">
								Review Order <span class="badge badge-danger lb-count-order" style="position: absolute;top: -12px;right: -5px;background-color: #ea111b;color: #fff;font-weight: bold;font-size: 17px !important;padding: 4px 8px;height: 26px;border-radius: 50px !important;"><?php echo !empty($this->countStoreOrder)?$this->countStoreOrder:0 ?> </span>
							</button>
			...
			<div class="row" style="padding-top: 5px;">
				<div class="col-md-8">
					<?php if($role == 'FullAccess' || (is_array($role) && substr($role['operations_inventory'], -1) == '1')): ?>
				...
				<?php if($role == 'FullAccess' || (is_array($role) && substr($role['operation_inventory_registry'], 0, 1) == '1')): ?>
				<div class="col-md-4" style="">
					<div style="text-align: right;">
						<button type="button" class="btn green" onclick="inventoryWarehouse.inventoryRegistry()">
							Inventory Registry
						</button>
					</div>
				</div>
